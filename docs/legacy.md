...
Program format and matching storage are unchanged. This is additional correctness coverage, not CPU/RSS evidence or complete ECMAScript conformance. Unicode sets/string properties under `v`, scoped flags, broader Test262/fuzzing, efficient moving-GC resumption and the host adapter remain outstanding.
