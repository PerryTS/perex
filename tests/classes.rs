...
fn class_normalization_merges_duplicates_and_overlaps_without_more_storage() {
    ...
    assert_eq!(mixed[8 + 3], 3); // Property union uses its existing evaluator.
}
